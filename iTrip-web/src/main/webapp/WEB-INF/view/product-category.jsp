...
<body>
	<nav class="breadcrumb">
		...
		产品管理 <span class="c-gray en">&gt;</span> 分类管理<a
	...
	<iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO
		width=100% height=300px SRC="product-category-add.do"></iframe>
	<div class="level">
			...
			<tr>
				...
				<td>
					<button class="btn btn-primary radius" type="button"
						onClick="product_del(this,'${lev.id}','${lev.type}')">
						<i class="Hui-iconfont">&#xe632;</i>删除
					</button> <input type="button" value="编辑"
					style="width: 80px; height: 30px; border: 1px; background-color: pink">
				</td>
			</tr>
		</c:forEach>
	</table>
